...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'lhuang15', 'email': 'lhuang15@terpmail.umd.edu', 'first_name': 'Lirong', 'last_name': 'Huang',
         'password': generate_password_hash('lhuang15', method='sha256'), 'role': 'STUDENT'},
